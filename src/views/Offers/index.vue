      ...
      >
        ...
        <div class="more__news text-right" style="direction:rtl">
          <div class="p__info">
            ...
            <div>
              <p>
                  هذا العرض مقدم من شركة رد تاغ لدعم المتبرعين بفائض ملابسهم لصالح مشروع كسوة
              </p>
              <p>
                من خلال العرض تستطيع أن تتسوق أون لاين من خلال موقع رد تاغ امسح الرمز الموجود بالكوبون الذي وصلك واطلب
              </p>
              <p>
              ...
              <ul>
                ...
                <li>تستخدم في جميع محلات رد تاغ و تونتي 4 في السعودية</li>
                <li>هذا العرض مقدم من شركة رد تاغ دور كسوة هو توزيعها على المتبرعين فقط</li>
                <li>تاريخ صلاحية هذه البطاقة</li>
              </ul>
            </div>
          </div>
          <img
